...
public class Main extends Application {
  ...
  public static Text dispLevel = new Text();
  ...
  private static Group addElements(int level) {
    ...
    p = new Paddle();
    newroot.getChildren().add(Paddle.paddle_rect);
    ...
    dispLevel.setText("Level: " + level);
    dispLevel.setY(SIZE * 0.03);
    dispLevel.setX(SIZE * 0.5);
    dispLevel.setFill(Color.GREEN);
    dispLevel.setOpacity(1);
    dispLevel.setFont(Font.font(STYLESHEET_MODENA, FontWeight.BOLD, 20));
    newroot.getChildren().add(dispLevel);
